...
const timeOutId = setTimeout(() => { clearInterval(timerId); document.querySelector('.root').innerHTML = ''; new Statistic(new ViewMethods(), createCallbackSprint).renderStat(rightAnswers, wrongAnswers); }, 60000);
